...
export default async function Page() {
  ...
  return <main className="min-h-screen bg-background px-4 pb-12 pt-8"><SteuerTabs /><div className="mx-auto max-w-3xl"><ElsterReviewPackage unresolvedFields={Object.values(answers).filter((value) => !String(value ?? "").trim()).length} /></div></main>
}
