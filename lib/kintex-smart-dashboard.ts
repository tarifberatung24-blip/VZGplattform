...
export const smartDashboardModules = [
  ...
  { id: "kintex-radar", labelBg: "HORIZON Radar", labelDe: "HORIZON Radar", status: "next", dataSources: ["profiles", "contracts", "documents", "deadlines", "audit_events"] },
