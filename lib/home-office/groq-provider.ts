...
export const groqAnalysisSchema = z.object({
  documentType: z.string(), sender: z.string(), recipient: z.string(), customerNumber: z.string(), contractNumber: z.string(), referenceNumber: z.string(), issueDate: z.string(), receivedDate: z.string(), deadline: z.string(), deadlineConfidence: z.number().min(0).max(1), requiredAction: z.string(), amountInvolved: z.string(), amounts: z.array(z.string()), currency: z.string(), summaryBg: z.string(), summaryDe: z.string(), facts: z.array(z.object({ label: z.string(), value: z.string(), confidence: z.number().min(0).max(1) })), risks: z.array(z.string()), missingInformation: z.array(z.string()), recommendedNextSteps: z.array(z.string()), confidence: z.number().min(0).max(1), evidenceSnippets: z.array(z.string())
}).strict()
