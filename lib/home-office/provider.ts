...
export function createDemoAnalysis(fileName: string): DemoAnalysis {
  return {
    documentType: "Bescheid (Demo)", sender: "Finanzamt Frankfurt (Demo)", recipient: "Demo-Kundin / Demo-Kunde", customerNumber: "DEMO-10482", contractNumber: "Nicht angegeben", referenceNumber: "FA-2026-0815", issueDate: "12.08.2026", receivedDate: "14.08.2026", deadline: "31.12.2026", deadlineConfidence: 0.87, requiredAction: "Проверете данните в оригинала", amountInvolved: "1.250,00 EUR", amounts: ["1.250,00"], currency: "EUR",
