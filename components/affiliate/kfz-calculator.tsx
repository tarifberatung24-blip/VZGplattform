...
const copy: Record<Locale, InsuranceCalculatorCopy> = {
  bg: {
    ...
    limits:
      "Тази форма само подготвя входните данни. Тя не дава гарантирана премия, не гарантира приемане и не посочва „най-добър“ застраховател. Крайната цена и приемането се определят от застрахователя.",
    privacy: "Не въвеждай чувствителни данни за планиране. Данните не се съхраняват и не се изпращат от HORIZON by VZG.",
    cta: "Сравни при партньора",
    unavailable: "Партньорската връзка за Kfz още не е конфигурирана.",
  },
  de: {
...
export function KfzCalculator({ locale, isConfigured }: { locale: Locale; isConfigured: boolean }) {
  return (
    <InsuranceCalculator
      offerId="kfz"
