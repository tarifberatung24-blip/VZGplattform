...
export function SiteHeader() {
  ...
  const labels = locale === "de"
    ? { home: "Startseite", services: "Leistungen", taxes: "Steuern", benefits: "Staatliche Hilfen", tariffs: "Tarife", documents: "Dokumente", about: "Über VZGplattform", profile: "Persönlicher Bereich", logout: "Abmelden", install: "App installieren", menu: "Menü" }
    : { home: "Начало", services: "Услуги", taxes: "Данъци", benefits: "Държавни помощи", tariffs: "Тарифи", documents: "Документи", about: "За VZGplattform", profile: "Личен профил", logout: "Изход", install: "Инсталирай приложението", menu: "Меню" }
  const links = [
  ...
  return (
    ...
    <header className="sticky top-0 z-40 border-b border-border bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-[72px] max-w-[1440px] items-center justify-between gap-4 px-5 lg:px-8">
        <Link href="/" aria-label="VZGplattform — BY VZG" className="shrink-0">
          <Logo />
        </Link>
