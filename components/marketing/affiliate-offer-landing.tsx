...
const content: Record<AffiliateOfferId, { icon: typeof FileSearch; bg: OfferCopy; de: OfferCopy }> = {
  "business-insurance": {
    icon: Building2,
    bg: {
      eyebrow: "Firmenversicherung", title: "Застраховки за твоята фирма, подготвени ясно", intro: "Подготви данните за дейността си и разбери кои покрития са ти нужни — Betriebshaftpflicht, Inhaltsversicherung и Rechtsschutz. Офертата идва от партньора.", benefits: ["Betriebshaftpflicht, Inhaltsversicherung и Rechtsschutz разграничени", "Бранш, правна форма и служители подготвени", "Директно към официалния партньор"], steps: ["Опиши дейността и правната форма", "Избери желаните покрития", "Продължи към партньора за оферта"], caution: "Цената и приемането зависят от данните за дейността и се потвърждават от застрахователя. HORIZON by VZG не е застраховател.", cta: "Weiter zum Partner", unavailable: "Партньорската връзка се настройва. Използвай формата за контакт, за да те уведомим." },
    de: {
      eyebrow: "Firmenversicherung", title: "Versicherungen für dein Unternehmen, klar vorbereitet", intro: "Bereite deine Angaben zur Tätigkeit vor und verstehe, welche Deckungen du brauchst — Betriebshaftpflicht, Inhaltsversicherung und Rechtsschutz. Das Angebot kommt vom Partner.", benefits: ["Betriebshaftpflicht, Inhaltsversicherung und Rechtsschutz unterschieden", "Branche, Rechtsform und Mitarbeitende vorbereitet", "Direkt zum offiziellen Partner"], steps: ["Tätigkeit und Rechtsform beschreiben", "Gewünschte Deckungen wählen", "Beim Partner ein Angebot anfragen"], caution: "Preis und Annahme hängen von den Angaben zur Tätigkeit ab und werden vom Versicherer bestätigt. HORIZON by VZG ist kein Versicherer.", cta: "Weiter zum Partner", unavailable: "Der Partnerlink wird gerade eingerichtet. Über das Kontaktformular informieren wir dich, sobald er aktiv ist." },
  },
  schufa: {
    icon: FileSearch,
    bg: {
