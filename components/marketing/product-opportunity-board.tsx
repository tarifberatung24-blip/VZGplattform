      ...
      <div className="mx-auto max-w-7xl px-4 pb-16 pt-10 sm:px-6 md:pb-24 md:pt-16 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 max-w-2xl text-pretty text-base leading-7 text-muted-foreground sm:text-lg">
            VZGplattform sammelt nur die Angaben, die fuer ein echtes Angebot gebraucht werden. Danach geht die Anfrage an den n8n Workflow und wird manuell bearbeitet.
          </p>
        </div>
