...
const content: Record<LegalPageType, { title: string; titleBg: string; intro: string; sections: Array<[string, string]> }> = {
  ...
  privacy: {
    ...
    intro: "Informationen zur Verarbeitung personenbezogener Daten bei VZGplattform.",
    sections: [
      ...
      ["Partnerlinks", "Verlassen Sie VZGplattform über einen Partnerlink, gelten die Datenschutzinformationen des jeweiligen Partners. VZGplattform erhält keinen Zugriff auf den Vertrag, den Sie direkt beim Partner abschließen."],
  ...
  terms: {
    ...
    intro: "Rahmenbedingungen für die Nutzung der VZGplattform-Plattform durch Privatkunden.",
    sections: [
      ["Geltungsbereich", "Diese Bedingungen regeln die Nutzung der digitalen VZGplattform-Plattform durch private Nutzerinnen und Nutzer."],
      ["Leistungsumfang", "VZGplattform unterstützt beim Ordnen von Dokumenten, beim Anzeigen von Vertragsinformationen und bei der verständlichen Orientierung. Der konkrete Funktionsumfang kann sich je nach freigeschaltetem Bereich unterscheiden."],
      ...
      ["Kosten", "Die Plattform enthält derzeit keinen eigenen Online-Checkout. Bevor kostenpflichtige VZGplattform-Leistungen online buchbar werden, werden Preis, Leistungsumfang, Vertragslaufzeit und die hierfür geltenden Verbraucherinformationen separat veröffentlicht."],
    ],
  },
  affiliate: {
    ...
    sections: [
      ...
      ["Vergütung", "Bei einem erfolgreichen Abschluss über einen gekennzeichneten Link kann VZGplattform vom Partner eine Vergütung erhalten. Für Sie entstehen durch das Anklicken eines Links allein keine zusätzlichen Kosten."],
      ["Unabhängige Entscheidung", "Ob ein Angebot zu Ihnen passt, entscheiden Sie selbst anhand der Vertragsunterlagen des Partners. VZGplattform gibt keine individuelle Finanz-, Versicherungs-, Kredit- oder Rechtsberatung."],
  ...
  withdrawal: {
    ...
    intro: "Hinweise zu Verträgen mit VZGplattform und zu externen Partnerangeboten.",
    sections: [
      ["Aktueller Stand", "Über diese Website wird derzeit kein eigener kostenpflichtiger Vertrag mit VZGplattform online abgeschlossen. Deshalb gibt es aktuell kein separates Online-Widerrufsformular für VZGplattform-Leistungen."],
      ...
      ["Künftige kostenpflichtige Leistungen", "Bevor VZGplattform eigene kostenpflichtige Leistungen online anbietet, werden die gesetzlich erforderlichen Verbraucherinformationen, Preise, Laufzeiten und eine passende Widerrufsbelehrung bereitgestellt."],
    ],
  },
}
