...
const content: Record<LegalPageType, { title: string; titleBg: string; intro: string; sections: Array<[string, string]> }> = {
  ...
  terms: {
    ...
    sections: [
      ...
      ["Kosten", "Die Plattform enthält derzeit keinen eigenen Online-Checkout. Bevor kostenpflichtige HORIZON-Leistungen online buchbar werden, werden Preis, Leistungsumfang, Vertragslaufzeit und die hierfür geltenden Verbraucherinformationen separat veröffentlicht."],
    ],
  },
  affiliate: {
