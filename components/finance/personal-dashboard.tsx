  ...
  return (
    <section className="mt-10 border-y border-border py-8" aria-labelledby="radar-title">
      <div className="grid gap-6 lg:grid-cols-[1fr_320px] lg:items-end">
        <div>
          <p className="nm-kicker">HORIZON Radar</p>
